...
class Cart(models.Model):
    ...
    mainFlower1_price = models.IntegerField(null=True)
    ...
    mainFlower2_price = models.IntegerField(null=True)
    ...
    mainFlower3_price = models.IntegerField(null=True)
    ...
    subFlower1_price = models.IntegerField(null=True)
    ...
    subFlower2_price = models.IntegerField(null=True)
    ...
    subFlower3_price = models.IntegerField(null=True)
    ...
    bunchOfFlowers1_price = models.IntegerField(null=True)
    ...
    bunchOfFlowers2_price = models.IntegerField(null=True)
